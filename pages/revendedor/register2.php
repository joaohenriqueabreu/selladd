<div class="custom-background-6 custom-super-section" layout="column" layout-align="center center">

    <h3 class="custom-color-white" align="center">
        <strong>Ta esperando o que?
        </strong>
    </h3>
    ...
    <h3 class="custom-color-white" align="center">
        <span class="custom-brand-white-small">#vendeai</span>
    </h3>
</div>