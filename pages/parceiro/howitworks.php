        ...
        <div layout="row" class="wow fadeInRight custom-fade-in-right animated" data-wow-offset="20"
            ...
            <div flex="50" class="" layout-align="center center" layout="row">
                <h4 class="custom-desc-text custom-color-green custom-border-green rounded-5x custom-padding-20 custom-color-white custom-hover-bg-green custom-hover-color-white">
                    <strong>Realize seu cadastro. Nossa equipe entrará em contato para orientá-lo</strong></h4>
            </div>
...
<!--                    <strong>Disponibilize seus produtos na plataforma virtual e defina quanto você quer pagar de comissão</strong></h4>-->
                    <strong>Defina seus produtos na plataforma virtual e quanto você quer pagar de comissão</strong></h4>
            </div>
...
<!--                    <strong>Vendedores espalhados por todo o Brasil escolhem produtos para montar suas lojas virtuais. Chamamos eles de revendedores do seu produto</strong></h4>-->
                    <strong>Pessoas espalhados por todo o Brasil escolhem produtos para montar suas lojas virtuais.</strong></h4>
            </div>
        ...
        <div layout="row" class="wow fadeInRight custom-fade-in-right animated" data-wow-offset="20"
            ...
            <div flex="50" class="" layout-align="center center" layout="row">
                <h4 class="custom-desc-text custom-color-green custom-border-green rounded-5x custom-padding-20 custom-color-white custom-hover-bg-green custom-hover-color-white">
                    <strong>Receba a notificação na hora</strong></h4>
            </div>
        ...
        <div layout="row" class="wow fadeInRight custom-fade-in-right animated" data-wow-offset="20"
            ...
            <div flex="50" class="" layout-align="center center" layout="row">
                <h4 class="custom-desc-text custom-color-green custom-border-green rounded-5x custom-padding-20 custom-color-white custom-hover-bg-green custom-hover-color-white">
                    <strong>Despache o produto para o cliente do seu revendedor</strong></h4>
            </div>
        ...
        <div layout="row" class="wow fadeInLeft custom-fade-in-left animated" data-wow-offset="20"
            ...
            <div flex="50" class="" layout-align="center center" layout="row">
                <h4 class="custom-desc-text custom-color-green custom-border-green rounded-5x custom-padding-20 custom-color-white custom-hover-bg-green custom-hover-color-white">
                    <strong>Receba pelo produto vendido. Cuidamos do pagamento e controle das comissões</strong></h4>
            </div>
