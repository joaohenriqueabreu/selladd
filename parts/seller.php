<section id="embaixador">
    <div class="custom-bg-dark-blue custom-section" layout-gt-sm="row" layout-xs="column"
        ...
        <div flex="70" layout="column" layout-align="center center">
            <h2 align="justify" class="custom-color-white"><strong>Você está pensando em montar um negócio próprio ou
                    está
                    buscando
                    alternativas de
                    renda extra?
                    Você não possui dinheiro para investir e não quer se expor ao risco de um novo negócio convencional?
